...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `sg_security` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8_general_ci  */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1504082935077269507 DEFAULT CHARSET=utf8mb4 COLLATE=utf8_general_ci  COMMENT='菜单表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_role` (
  ...
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8_general_ci  COMMENT='角色表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_user` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COLLATE=utf8_general_ci  COMMENT='用户表';
/*!40101 SET character_set_client = @saved_cs_client */;
